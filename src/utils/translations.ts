...
export const translations = {
  ar: {
    ...
    startGameBtn: '▶ ابدأ اللعبة (قفل الإعدادات)',
    chestNumber: 'صندوق رقم',
    prizePlaceholder: 'اكتب الجائزة (مثلاً: 5000 دينار، iPhone، كردونة...)',
    detectedNumeric: 'القيمة المالية المحسوبة:',
    noNumeric: 'جائزة عينية / غير نقدية (تحسب 0 د.ت في عرض البنكار)',
  ...
  fr: {
    ...
    startGameBtn: '▶ Lancer le Jeu (Verrouiller)',
    chestNumber: 'Boîte N°',
    prizePlaceholder: 'Contenu du prix (ex: 5000 Dinars, iPhone, Boîte vide...)',
    detectedNumeric: 'Valeur monétaire détectée :',
    noNumeric: 'Prix matériel / non numérique (comptabilisé 0 DT pour la banque)',
